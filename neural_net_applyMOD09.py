...
# run neural_net_applyMOD09.py
# python neural_net_applyMOD09.py
...
##METALIST## 
############
metalist = glob.glob(workfolder+'2005_233*/')
print(metalist)
...
for folder in metalist:
    ...
    if not os.path.exists('/scratch/clisap/seaice/OWN_PRODUCTS/MELT_PONDS/PRODUCTS/'+date+'/'+date+'_ow.data'):
        ...
        print('...done')
        print('pickle data')
        cmd('mkdir /scratch/clisap/seaice/OWN_PRODUCTS/MELT_PONDS/PRODUCTS/'+date)
        pickle.dump(mp,open('/scratch/clisap/seaice/OWN_PRODUCTS/MELT_PONDS/PRODUCTS/'+date+'/'+date+'_mp.data','w'))
        print('mp pickled')
        pickle.dump(snow,open('/scratch/clisap/seaice/OWN_PRODUCTS/MELT_PONDS/PRODUCTS/'+date+'/'+date+'_snow.data','w'))
        print('snow pickled')
        pickle.dump(ow,open('/scratch/clisap/seaice/OWN_PRODUCTS/MELT_PONDS/PRODUCTS/'+date+'/'+date+'_ow.data','w'))
