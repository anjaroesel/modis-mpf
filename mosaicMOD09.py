...
####---snow1:
year='2011'
workfolder='/scratch/clisap/seaice/OWN_PRODUCTS/MELT_PONDS/MOD09/processed/processed2/'
#workfolder='/scratch/clisap/seaice/OWN_PRODUCTS/MELT_PONDS/GRIDDATAMOD09/MOD09GA/'
...
#move folder 
#print('moving folder')
#cmd('mv /scratch/clisap/seaice/OWN_PRODUCTS/MELT_PONDS/MOD09/processed/processed2/*mosaic /scratch/clisap/seaice/OWN_PRODUCTS/MELT_PONDS/GRID_MOSAIC/')
