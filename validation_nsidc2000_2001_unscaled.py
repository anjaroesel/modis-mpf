...
# run validation_nsidc2000_2001_unscaled.py
...
xbmin,xbmax=xb-5.0,xb+5.  ###NSIDC data are in a 10x10 km grid with a center coordinate latb,lonb
ybmin,ybmax=yb-5.,yb+5.
...
xcmin,xcmax=xc-5.0,xc+5.  ###NSIDC data are in a 10x10 km grid with a center coordinate latb,lonb
ycmin,ycmax=yc-5.,yc+5.
...
xfmin,xfmax=xf-5.0,xf+5.  ###NSIDC data are in a 10x10 km grid with a center coordinate latb,lonb
yfmin,yfmax=yf-5.,yf+5.
...
xsmin,xsmax=xs-5.0,xs+5.  ###NSIDC data are in a 10x10 km grid with a center coordinate latb,lonb
ysmin,ysmax=ys-5.,ys+5.
...
#2000
dataset0=folder+'2000_169/2000_169_mp_125.nc'   #2989809893047
...
#2001
dataset0=folder+'2001_153/2001_153_mp_125.nc'  #nan,8,4,1,2,nan,5
dataset1=folder+'2001_161/2001_161_mp_125.nc'
dataset2=folder+'2001_185/2001_185_mp_125.nc'
dataset3=folder+'2001_193/2001_193_mp_125.nc'
dataset4=folder+'2001_201/2001_201_mp_125.nc'
dataset5=folder+'2001_209/2001_209_mp_125.nc'
dataset7=folder+'2001_225/2001_225_mp_125.nc'
dataset8=folder+'2001_233/2001_233_mp_125.nc'
dataset9=folder+'2001_241/2001_241_mp_125.nc'
dataset10=folder+'2001_249/2001_249_mp_125.nc'
dataset11=folder+'2001_217/2001_217_mp_125.nc'
...
#Beauf
iyy=nonzero(MPY>=yb)[0]
iyy=iyy[0]
iyymin=iyy-4
iyymax=iyy+5
iY=range(iyymin,iyymax,1)


ixx=nonzero(MPX>=xb)[0]
ixx=ixx[0]
ixxmin=ixx-4
ixxmax=ixx+5
iX=range(ixxmin,ixxmax,1)
